...
<head>
	...
	if($cur_page == 'embroidery.php') {
		?>
		<title><?php echo $embroidery_meta_title; ?></title>
		<meta name="keywords" content="<?php echo $embroidery_meta_keyword; ?>">
		<meta name="description" content="<?php echo $embroidery_meta_description; ?>">
		<?php
	}
				...
				<div class="menu-container">
					<div class="menu">
						<ul>
							...
							<li><a href="embroidery.php"><?php echo $embroidery_title; ?></a></li>
